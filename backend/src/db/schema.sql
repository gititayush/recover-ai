...
CREATE TABLE IF NOT EXISTS recovery_actions (
  ...
  action_type TEXT NOT NULL CHECK (action_type IN ('CREATE_PAYMENT_LINK', 'REQUEST_MANUAL_REVIEW', 'NO_ACTION', 'CUSTOMER_OUTREACH', 'DISPATCH_VERNACULAR_ASSIST')),
...
ALTER TABLE recovery_actions DROP CONSTRAINT IF EXISTS recovery_actions_action_type_check;
ALTER TABLE recovery_actions ADD CONSTRAINT recovery_actions_action_type_check CHECK (
  action_type IN ('CREATE_PAYMENT_LINK', 'REQUEST_MANUAL_REVIEW', 'NO_ACTION', 'CUSTOMER_OUTREACH', 'DISPATCH_VERNACULAR_ASSIST')
);
...
ALTER TABLE audit_events ADD CONSTRAINT audit_events_event_type_check CHECK (
  event_type IN (
    ...
    'COMMUNICATION_DISPATCHED', 'COMMUNICATION_FAILED', 'COMMUNICATION_STATUS_UPDATED'
  )
);
